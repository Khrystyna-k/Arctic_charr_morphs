...
#Select outlier SNPs based on LB vs SB contrast
```{r }
...
#Prepare data and select the most common refferense allele in on one of the benthic morphs (SB)
```{r }
library(tidyr)
library(reshape2)
...
#Select haplotypes based on conditions
```{r }
