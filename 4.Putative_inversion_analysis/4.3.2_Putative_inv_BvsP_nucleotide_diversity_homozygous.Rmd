...
```{r }
#Directory
dir <- '~/Desktop/Comp_UU/REF_SalAlp_UK/Inversions/Nucleotide_diversity/Homo_BvsP_Thin_pestpg'
...
#List
desired_files <- c(
  "ind_list_homB_chr_1_part1.txt_inv_reg_chr1_1.theta.5kb.thetasWindow.gz.pestPG",
  "ind_list_homB_chr_1_part2.txt_inv_reg_chr1_2.theta.5kb.thetasWindow.gz.pestPG",
  "ind_list_homB_chr_3_part1.txt_inv_reg_chr3_1.theta.5kb.thetasWindow.gz.pestPG",
  "ind_list_homB_chr_3_part2.txt_inv_reg_chr3_2.theta.5kb.thetasWindow.gz.pestPG",
  "ind_list_homB_chr_8_part_1.txt_inv_reg_chr8.theta.5kb.thetasWindow.gz.pestPG",
  "ind_list_homB_chr_9_part_1.txt_inv_reg_chr9.theta.5kb.thetasWindow.gz.pestPG",
  "ind_list_homB_chr_14_part_1.txt_inv_reg_chr14.theta.5kb.thetasWindow.gz.pestPG",
  "ind_list_homB_chr_40_part_1.txt_inv_reg_chr40.theta.5kb.thetasWindow.gz.pestPG",
    "ind_list_homP_chr_1_part1.txt_inv_reg_chr1_1.theta.5kb.thetasWindow.gz.pestPG",
  "ind_list_homP_chr_1_part2.txt_inv_reg_chr1_2.theta.5kb.thetasWindow.gz.pestPG",
  "ind_list_homP_chr_3_part1.txt_inv_reg_chr3_1.theta.5kb.thetasWindow.gz.pestPG",
  "ind_list_homP_chr_3_part2.txt_inv_reg_chr3_2.theta.5kb.thetasWindow.gz.pestPG",
  "ind_list_homP_chr_8_part_1.txt_inv_reg_chr8.theta.5kb.thetasWindow.gz.pestPG",
  "ind_list_homP_chr_9_part_1.txt_inv_reg_chr9.theta.5kb.thetasWindow.gz.pestPG",
  "ind_list_homP_chr_14_part_1.txt_inv_reg_chr14.theta.5kb.thetasWindow.gz.pestPG",
  "ind_list_homP_chr_40_part_1.txt_inv_reg_chr40.theta.5kb.thetasWindow.gz.pestPG")
...
df.theta.nsites_clean_boxplot <- 
  ...
  mutate(
    Inversion = case_when(Chr == 1 & WinCenter_less >= 16.30 & WinCenter_less <= 18.60 ~ 'Inv1',
                               ...
                               Chr == 8 & WinCenter_less >= 29.00 & WinCenter_less <= 29.95 ~ 'Inv8',
                               Chr == 9 & WinCenter_less >= 38.40 & WinCenter_less <= 40.80 ~ 'Inv9',
                               Chr == 14 & WinCenter_less >= 6.30 & WinCenter_less <= 6.90 ~ 'Inv14',
                               Chr == 40 & WinCenter_less >= 16.25 & WinCenter_less <= 17.00 ~ 'Inv40'
                               ),
        Group = case_when(
...
plt <- ggplot(df.theta.nsites_clean_boxplot_inv_only) +
  ...
  annotate('text', y = 0.004, x= 0.8, label="***", size = 5)+
  annotate('text', y = 0.004, x= 1.2, label="***", size = 5)+
  annotate('text', y = 0.003, x= 1.8, label="***", size = 5)+
  annotate('text', y = 0.003, x= 2.2, label="***", size = 5)+
  annotate('text', y = 0.004, x= 3, label="***", size = 5)+
  annotate('text', y = 0.002, x= 4, label="**", size = 5)+
  annotate('text', y = 0.003, x= 5, label="***", size = 5)+
  annotate('text', y = 0.004, x= 6, label="***", size = 5)

#ggsave('~/Desktop/Comp_UU/REF_SalAlp_UK/Inversions/Output/Boxplots_nucl_div_HomoBvsP.pdf', plt, width = 10, height= 2.5)

```



#Data genome wide (added across 6 largest representative chomosomes)
```{r }
#Directory
...
df.x2 <- data.frame(pop = names(l.theta),
                    pairwise.nuc = round(unlist(l.theta), 4),  #16 is the number of populations
                    wattersons.theta = round(unlist(l.watt), 4),
                    number.sites = round(unlist(l.sum), 4))
...
#Combine the genome-wide and within groups
```{r}
...
plt <- ggplot(df.theta.nsites_clean_genome_wide_homo) +
  ...
  annotate('text', y = 0.004, x= 1, label="***", size = 5)+
  annotate('text', y = 0.0045, x= 1.8, label="***", size = 5)+
  annotate('text', y = 0.004, x= 2.2, label="***", size = 5)+
  annotate('text', y = 0.003, x= 2.8, label="***", size = 5)+
  annotate('text', y = 0.003, x= 3.2, label="***", size = 5)+
  annotate('text', y = 0.004, x= 4, label="***", size = 5)+
  annotate('text', y = 0.002, x= 5, label="**", size = 5)+
  annotate('text', y = 0.003, x= 6, label="***", size = 5)+
  annotate('text', y = 0.007, x= 7, label="***", size = 5)+
  annotate("text", x = 1, y =  0.0057, label = "Benthic", color = "brown3", size = 5,
           fontface = "bold")+
  annotate("text", x = 1, y =  0.005, label = "Pelagic", color = "darkgreen", size = 5,
           fontface = "bold")+
  annotate("text", x = 5, y =  0.0057, label = "Homozygous benthic", color = "#67a9cf", size = 5,fontface = "bold")+
  annotate("text", x = 5, y =  0.005, label = "Homozygous pelagic", color = "brown4", size = 5, fontface = "bold")+
